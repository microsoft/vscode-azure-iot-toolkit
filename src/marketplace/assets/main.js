...
const app = new Vue({
    ...
    created: async function () {
        try {
            this.list = await this.getModules();
            this.name = await this.postModules();
        } catch (error) {
    ...
    methods: {
        getModules: async function () {
            return (await axios.get(`${this.endpoint}/api/test/get`)).data;
        },
        postModules: async function () {
            const b =  {
                name: 'bbb',
                age: 20
            };
            return (await axios.post(`${this.endpoint}/api/test/post`, b)).data;
        },
