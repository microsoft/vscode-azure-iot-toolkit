...
2. If you have not set Iot Hub Connection String before, an input box will pop up, then enter your Iot Hub Connection String (It is one-time configuration, and please makre sure it is **Iot Hub Connection String** not **Device Connection String**).
